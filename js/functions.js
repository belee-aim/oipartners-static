...
! function(t) {
    ...
    e.addClass("breakpoint-" + f), t(window).bind("breakpoint-change", function(t) {
        ...
        maps: function() {
            var i = t(".map");
            if (i.length > 0) {
                if (void 0 === t.fn.gmap3) return INSPIRO.elements.notification("Warning", "jQuery gmap3 plugin is missing, please go to this <a href='http://support.inspirothemes.com/help-center/articles/8/14/65/google-maps'>help article</a> and follow instructions on how to configure google maps.", "danger"), !0;
                i.each(function() {
                    var i, e = t(this);
                    e.options = {
...
/*
     FILE ARCHIVED ON 23:07:21 Mar 14, 2025 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:16:40 Apr 25, 2026.
...
playback timings (ms):
  ...
  esindex: 0.007
  cdx.remote: 35.018
  LoadShardBlock: 290.028 (3)
  PetaboxLoader3.datanode: 304.436 (4)
  load_resource: 164.627
  PetaboxLoader3.resolve: 119.902
*/